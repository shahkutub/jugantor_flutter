...
class PhotoGalDetailsFromHomeFragment extends StatelessWidget{
            ...
            children: [
              ...
              Obx(() =>
                  Container(
                      ...
                      child:homeController.last_photo_albumList[0].images!.length > 0 ?
                      //Expanded(
                         // child:
                      ListView.builder(
                          primary: false,
                          shrinkWrap: true,
                          itemCount: homeController.last_photo_albumList[0].images!.length,
                                ...
                                GestureDetector(
                                  ...
                                  Material(
                                    ...
                                    child: CachedNetworkImage(
                                      imageUrl: homeController.last_photo_albumList[0].images![index],
                                      fit: BoxFit.fill,
                                      height: 200,
                                      width: width*0.92,
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                              ...
                              color: Colors.deepPurple,
                              child: Text(homeController.fromhomectnme.value.toString()+' -এর আরো ছবির অ্যালবাম',
                          ...
                          Container(
                              ...
                              GridView.builder(
                                ...
                                itemBuilder: (context, index2) {
                                  ...
                                  var text = homeController.cat_wise_photoList[index2].album_photos.toString();
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Container(
                                                  ...
                                                  child: Text(homeController.cat_wise_photoList[index2].album_name.toString(),
                                                    style: TextStyle(color: Colors.black,fontSize: 10,fontWeight:FontWeight.bold ),
                                                    textAlign: TextAlign.justify,
                                                    maxLines: 2,
                                                  ),
